...
public class ControllerE {
	...
	/*
	 * 2개의 정수형 인수를 전달받아 method 선언을 할때 정수형 매개변수 2개가 필요 덧셈을 수행한후 결과는 int 형이다 결과를
	 * return 하는 method method 의 return type 이 int
	 */
	public static int add(int num1, int num2) {
		// 결과값을 변수에 저장후 return
		// add() mrthod 입장에서 보면 num1 과 num2 에는
	...
	public static void main(String[] args) {
		...
		//    저장하려면 그 변수의 type 의 add() method 의

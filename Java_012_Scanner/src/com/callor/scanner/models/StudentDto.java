...
public class StudentDto {
	 ...
	 * 멤버 변수, 멤버 method에 접근제한자가 없을떄
	 * 1. package 가 다른 곳에서 멤버 **에 접근하려고 하면 접근이 안된다
	 * 2. public 접근제한자가 있으면 packge 에 관계없이 
	 * 현재 프로젝트의 어떤 곳에서든 자유롭게 접근이 가능
	 * 3. private 접근제한자가 있으면 현재 클래스의 멤버 method 에서만
	 * 접근이 가능하다
	 * 
	 * Dto 클래스의 멤버 변수와 getter, setter method
	 * java 의 프로젝트 패턴에서 Dto 클래스의 멤버 변수는 
	 * 모두 private 선언
	 * private 로 선언된 멤버 변수에 값을 저장, 읽기 위하여 
	 ...
	 * 기본적으로 toString() 이라는 method 가 자동 생성된다
	 ...
	 * 맴버변수의 값을 문자열로 만들어서 return 하는 method 로 
	 * "재 정의(Override)" 했다.
	 */
	@Override

...
public class StringA {
	public static void main(String[] args) {
		 ...
		 * ..printf() 는 결과를 단순히 Consol 에 출력하는 용도 String.format() 은 결과를 다른 문자열 변수에 저장할 수
		 * 있다
		 * 
		 * print() 는 아마도 void printf() 일 것이고 format() 은 아마도 String format() 이고 return 문이
		 * 있을 것이다.
		 * 
		 */
		int num = 3;
	    ...
	    // printf() 단순히 Console 에 출력하는 일만 할수 있다
